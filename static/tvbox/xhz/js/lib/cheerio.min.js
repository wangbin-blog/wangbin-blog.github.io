...
function B(e) {
  ...
  for (; null !== (t = P.exec(e)); ) {
    ...
    void 0 !== a
      ...
      : ((n += `${e.substring(r, i)}&#x${w(e, i).toString(16)};`),
  ...
  switch (e.type) {
    ...
    case u:
      return (function (e, t) {
        var n;
        "foreign" === t.xmlMode &&
          ((e.name = null !== (n = G.get(e.name)) && void 0 !== n ? n : e.name),
          e.parent && Q.has(e.parent.name) && (t = { ...t, xmlMode: !1 }));
        ...
        (t.xmlMode
          ? !1 !== t.selfClosingTags
          : t.selfClosingTags && j.has(e.name))
          ? (t.xmlMode || (r += " "), (r += "/>"))
          : ((r += ">"),
    ...
    case a:
      return (function (e, t) {
        ...
        !1 ===
          ...
          (r = t.xmlMode || "utf8" !== t.encodeEntities ? B(r) : H(r));
        return r;
      })(e, t);
  }
}
...
function ne(e) {
  let { next: t } = e;
  for (; null !== t && !I(t); ) ({ next: t } = t);
  return t;
}
function re(e) {
  let { prev: t } = e;
  for (; null !== t && !I(t); ) ({ prev: t } = t);
  return t;
}
function ie(e) {
  if (
...
function oe(e, t, n = !0) {
  ...
  for (let i = 0; i < t.length && !r; i++) {
    ...
    I(s) &&
      (e(s)
        ? (r = s)
        : n && s.children.length > 0 && (r = oe(e, s.children, !0)));
  }
  return r;
}
const ce = {
...
function de(e, t) {
  ...
  return c.indexOf(l) > c.indexOf(h)
    ? o === t
      ? fe.FOLLOWING | fe.CONTAINED_BY
      : fe.FOLLOWING
    : o === e
      ? fe.PRECEDING | fe.CONTAINS
      : fe.PRECEDING;
}
function Ee(e) {
  return (
...
var Ie,
  Se = Object.freeze({
    ...
    prependChild: function (e, t) {
      if (
        (ie(t), (t.parent = e), (t.prev = null), 1 !== e.children.unshift(t))
      ) {
    ...
    existsOne: function e(t, n) {
      return n.some(
        (n) => I(n) && (t(n) || (n.children.length > 0 && e(t, n.children))),
      );
    },
    findAll: function (e, t) {
      ...
      for (; (s = i.shift()); ) {
        const t =
          null === (n = s.children) || void 0 === n ? void 0 : n.filter(I);
        ...
        ? "feed" === t.name
          ...
          : (function (e) {
              ...
              const r =
                  null !==
                    (n =
                      null === (t = Ae("channel", e.children)) || void 0 === t
                        ? void 0
                        : t.children) && void 0 !== n
                    ? n
                    : [],
  ...
  (He.prototype._getPreferredOutput = function (e) {
    ...
    switch (t) {
      case "all": {
        ...
        return (
          (e.pointer = He.toPointer(t)),
          (e.path =
            "string" == typeof e.path ? e.path : He.toPathString(e.path)),
          e
        );
      }
      case "value":
  ...
  (He.prototype._trace = function (e, t, n, r, i, s, a, o) {
    ...
    if (("string" != typeof l || o) && t && we.call(t, l))
      ...
      (p(this._trace(h, t, n, r, i, s, a)),
        this._walk(t, (r) => {
          "object" == typeof t[r] &&
            p(this._trace(e.slice(), t[r], Be(n, r), t, r, s, !0));
        }));
    else {
      if ("^" === l)
        return (
          (this._hasParentSelector = !0),
          { path: n.slice(0, -1), expr: h, isParentSelector: !0 }
        );
      if ("~" === l)
        return (
          (c = { path: Be(n, l), value: i, parent: r, parentProperty: null }),
      ...
      if ("$" === l) p(this._trace(h, t, n, null, null, s, a));
        ...
        this._walk(t, (a) => {
          this._eval(e, t[a], a, n, r, i) &&
            p(this._trace(h, t[a], Be(n, a), t, a, s, !0));
        });
      } else if ("(" === l[0]) {
        if (this.currPreventEval)
          throw new Error("Eval [(expr)] prevented in JSONPath expression.");
        p(
          this._trace(
            Fe(this._eval(l, t, n[n.length - 1], n.slice(0, -1), r, i), h),
            t,
            n,
            r,
            i,
        ...
        !o &&
          t &&
          we.call(t, l) &&
          p(this._trace(h, t[l], Be(n, l), t, l, s, a, !0));
    }
        ...
        return (
          this.firstUpdate &&
            (this.lineno && this.colno
              ...
              : this.lineno && (t += " [Line " + this.lineno + "]")),
          (t += "\n "),
          this.firstUpdate && (t += " "),
  ...
  if (
    ((s = e._events)
      ? (s.newListener &&
          ...
          (s = e._events)),
        (a = s[t]))
      : ((s = e._events = new mt()), (e._eventsCount = 0)),
    a)
  ) {
    if (
      ("function" == typeof a
...
((mt.prototype = Object.create(null)),
    ...
    if (n === t || (n.listener && n.listener === t))
      ...
      if (1 === n.length) {
        if (((n[0] = void 0), 0 == --this._eventsCount))
          return ((this._events = new mt()), this);
        delete r[e];
      } else
        !(function (e, t) {
  ...
  (Lt.prototype.enter = Lt.prototype.exit =
    function () {
      return this;
    }));
var vt,
  Dt = { Domain: Lt, createDomain: kt, create: kt },
...
function Ut() {
  var e = Et.domain;
  (e && (vt || (vt = Dt), (vt.active = Et.domain = null)),
      ...
      (t.nextToken = function () {
        ...
        if (this.in_code) {
          ...
          if (
            ...
            return ((this.in_code = !1), Kt("variable-end", e, t, n));
          if ("r" === r && "/" === this.str.charAt(this.index + 1)) {
            ...
            return Kt("regex", { body: i, flags: a }, t, n);
          }
          if (-1 !== "()[]{}%*-+~/#,:|.<>=!".indexOf(r)) {
            this.forward();
            var o,
            ...
            switch (
              (-1 !== je.indexOf(c, l) &&
                (this.forward(),
                (r = l),
                -1 !== je.indexOf(c, l + this.current()) &&
                  ((r = l + this.current()), this.forward())),
              r)
            ) {
              case "(":
                o = "left-paren";
          ...
          if (
            (e = this._extractUntil(" \n\t\r ()[]{}%*-+~/#,:|.<>=!")).match(
              /^[-+]?[0-9]+$/,
            )
          )
            return "." === this.current()
              ? (this.forward(),
                Kt("float", e + "." + this._extract("0123456789"), t, n))
              : Kt("int", e, t, n);
        ...
        if (
          ...
          return ((this.in_code = !0), Kt("block-start", e, t, n));
        if (
          (e = this._extractString(this.tags.VARIABLE_START + "-")) ||
          (e = this._extractString(this.tags.VARIABLE_START))
        )
          return ((this.in_code = !0), Kt("variable-start", e, t, n));
        e = "";
        var p = !1;
        for (
          this._matches(this.tags.COMMENT_START) &&
          ((p = !0), (e = this._extractString(this.tags.COMMENT_START)));
          null !== (h = this._extractUntil(u));
        ) {
          if (
            ((e += h),
...
var on = (function (e) {
  ...
  fn = ln.extend("Group"),
  dn = ln.extend("Array"),
  En = on.extend("Pair", { fields: ["key", "value"] }),
  mn = ln.extend("Dict"),
  Tn = on.extend("LookupVal", { fields: ["target", "val"] }),
  _n = on.extend("If", { fields: ["cond", "body", "else_"] }),
  An = _n.extend("IfAsync"),
  gn = on.extend("InlineIf", { fields: ["cond", "body", "else_"] }),
  Nn = on.extend("For", { fields: ["arr", "name", "body", "else_"] }),
  Cn = Nn.extend("AsyncEach"),
  In = Nn.extend("AsyncAll"),
  Sn = on.extend("Macro", { fields: ["name", "args", "body"] }),
  bn = Sn.extend("Caller"),
  On = on.extend("Import", { fields: ["template", "target", "withContext"] }),
  yn = (function (e) {
    function t() {
      return e.apply(this, arguments) || this;
    }
  ...
  Ln = on.extend("FunCall", { fields: ["name", "args"] }),
  kn = Ln.extend("Filter"),
  vn = kn.extend("FilterAsync", { fields: ["name", "args", "symbol"] }),
  Dn = mn.extend("KeywordArgs"),
  Rn = on.extend("Block", { fields: ["name", "body"] }),
  Mn = on.extend("Super", { fields: ["blockName", "symbol"] }),
  Pn = on.extend("TemplateRef", { fields: ["template"] }).extend("Extends"),
  xn = on.extend("Include", { fields: ["template", "ignoreMissing"] }),
  wn = on.extend("Set", { fields: ["targets", "value"] }),
  Bn = on.extend("Switch", { fields: ["expr", "cases", "default"] }),
  Fn = on.extend("Case", { fields: ["cond", "body"] }),
  Un = ln.extend("Output"),
  Hn = on.extend("Capture", { fields: ["body"] }),
  Gn = un.extend("TemplateData"),
  Yn = on.extend("UnaryOp", { fields: ["target"] }),
  qn = on.extend("BinOp", { fields: ["left", "right"] }),
  Kn = qn.extend("In"),
  jn = qn.extend("Is"),
  Vn = qn.extend("Or"),
  Wn = qn.extend("And"),
  ...
  rr = Yn.extend("Neg"),
  ir = Yn.extend("Pos"),
  sr = on.extend("Compare", { fields: ["expr", "ops"] }),
  ar = on.extend("CompareOperand", { fields: ["expr", "type"] }),
...
var hr = {
  ...
  printNodes: function e(t, n) {
    if (((n = n || 0), lr(t.typename + ": ", n), t instanceof ln))
      (lr("\n"),
...
var pr = (function (e) {
    ...
    return (
      ...
      (i.advanceAfterVariableEnd = function () {
        ...
        e && e.type === Vt.TOKEN_VARIABLE_END
      ...
      (i.parseFor = function () {
        ...
        if (
          (this.skipSymbol("for")
            ? ((e = new hr.For(n.lineno, n.colno)), (t = "endfor"))
            : this.skipSymbol("asyncEach")
              ? ((e = new hr.AsyncEach(n.lineno, n.colno)), (t = "endeach"))
              : this.skipSymbol("asyncAll")
                ? ((e = new hr.AsyncAll(n.lineno, n.colno)), (t = "endall"))
                : this.fail("parseFor: expected for{Async}", n.lineno, n.colno),
          (e.name = this.parsePrimary()),
          e.name instanceof hr.Symbol ||
            this.fail("parseFor: variable name expected for loop"),
          this.peekToken().type === Vt.TOKEN_COMMA)
        ) {
          var r = e.name;
          for (
            e.name = new hr.Array(r.lineno, r.colno), e.name.addChild(r);
      ...
      (i.parseCall = function () {
        ...
        var i = new hr.Symbol(e.lineno, e.colno, "caller"),
          ...
          a = n.args.children;
        return (
          a[a.length - 1] instanceof hr.KeywordArgs ||
            a.push(new hr.KeywordArgs()),
      ...
      (i.parseImport = function () {
        ...
        this.skipSymbol("as") ||
          this.fail('parseImport: expected "as" keyword', e.lineno, e.colno);
      ...
      (i.parseBlock = function () {
        ...
        return (
          n || this.fail("parseBlock: expected endblock, got end of file"),
          this.advanceAfterBlockEnd(n.value),
          t
        );
      }),
      ...
      (i.parseIf = function () {
        ...
        this.skipSymbol("elseif")
          ? (e = new hr.If(t.lineno, t.colno))
          : this.skipSymbol("ifAsync")
            ? (e = new hr.IfAsync(t.lineno, t.colno))
            : this.fail(
      ...
      (i.parseSet = function () {
        ...
        for (
          var t, n = new hr.Set(e.lineno, e.colno, []);
          (t = this.parsePrimary()) &&
          (n.targets.push(t), this.skip(Vt.TOKEN_COMMA));
        );
        return (
          this.skipValue(Vt.TOKEN_OPERATOR, "=")
            ? ((n.value = this.parseExpression()),
              this.advanceAfterBlockEnd(e.value))
            : this.skip(Vt.TOKEN_BLOCK_END)
              ? ((n.body = new hr.Capture(
                  e.lineno,
                  e.colno,
      ...
      (i.parseRaw = function (e) {
        ...
        return new hr.Output(a.lineno, a.colno, [
          new hr.TemplateData(a.lineno, a.colno, i),
        ]);
      }),
      ...
      (i.parseNot = function () {
        ...
        return this.skipSymbol("not")
          ? new hr.Not(e.lineno, e.colno, this.parseNot())
          : this.parseIn();
      }),
      (i.parseIn = function () {
      ...
      (i.parseUnary = function (e) {
        var t,
          n = this.peekToken();
        return (
          (t = this.skipValue(Vt.TOKEN_OPERATOR, "-")
            ? new hr.Neg(n.lineno, n.colno, this.parseUnary(!0))
            : this.skipValue(Vt.TOKEN_OPERATOR, "+")
              ? new hr.Pos(n.lineno, n.colno, this.parseUnary(!0))
              : this.parsePrimary()),
      ...
      (i.parsePrimary = function (e) {
        ...
        if (
          (n
            ? n.type === Vt.TOKEN_STRING
              ? (t = n.value)
              : n.type === Vt.TOKEN_INT
                ? (t = parseInt(n.value, 10))
                : n.type === Vt.TOKEN_FLOAT
                  ? (t = parseFloat(n.value))
                  : n.type === Vt.TOKEN_BOOLEAN
                    ? "true" === n.value
                      ? (t = !0)
                      : "false" === n.value
                        ? (t = !1)
                    ...
                    : n.type === Vt.TOKEN_NONE
                      ? (t = null)
                      : n.type === Vt.TOKEN_REGEX &&
                        (t = new RegExp(n.value.body, n.value.flags))
            : this.fail("expected expression, got end of file"),
          void 0 !== t
            ? (r = new hr.Literal(n.lineno, n.colno, t))
            : n.type === Vt.TOKEN_SYMBOL
              ? (r = new hr.Symbol(n.lineno, n.colno, n.value))
              : (this.pushToken(n), (r = this.parseAggregate())),
      ...
      (i.parseFilterName = function () {
        for (
          var e = this.expect(Vt.TOKEN_SYMBOL), t = e.value;
          this.skipValue(Vt.TOKEN_OPERATOR, ".");
        )
      ...
      (i.parseFilterArgs = function (e) {
        return this.peekToken().type === Vt.TOKEN_LEFT_PAREN
      ...
      (i.parseFilterStatement = function () {
        ...
        var i = new hr.Filter(
          ...
          t.colno,
          t,
          new hr.NodeList(t.lineno, t.colno, [r].concat(n)),
        );
      ...
      (i.parseAggregate = function () {
        ...
        for (;;) {
          ...
          if (
            n === Vt.TOKEN_RIGHT_PAREN ||
            n === Vt.TOKEN_RIGHT_BRACKET ||
      ...
      (i.parseSignature = function (e, t) {
        ...
        for (
          var r = new hr.NodeList(n.lineno, n.colno),
            i = new hr.KeywordArgs(n.lineno, n.colno),
            s = !1;
          ;
        ) {
          ...
          if (s && !this.skip(Vt.TOKEN_COMMA))
            ...
            this.skipValue(Vt.TOKEN_OPERATOR, "=")
              ? i.addChild(
                  new hr.Pair(a.lineno, a.colno, a, this.parseExpression()),
                )
              : r.addChild(a);
          }
          s = !0;
        ...
        for (var e, t = []; (e = this.nextToken()); )
          if (e.type === Vt.TOKEN_DATA) {
            ...
            (this.dropLeadingWhitespace &&
              ...
              r &&
                ((r.type === Vt.TOKEN_BLOCK_START &&
                  "-" === i.charAt(i.length - 1)) ||
                  (r.type === Vt.TOKEN_VARIABLE_START &&
                    "-" === i.charAt(this.tokens.tags.VARIABLE_START.length)) ||
                  (r.type === Vt.TOKEN_COMMENT &&
                    "-" === i.charAt(this.tokens.tags.COMMENT_START.length))) &&
                (n = n.replace(/\s*$/, "")),
              t.push(
                new hr.Output(e.lineno, e.colno, [
                  new hr.TemplateData(e.lineno, e.colno, n),
                ]),
              ));
...
function Tr(e, t, n) {
  ...
  if (e instanceof hr.NodeList) {
    ...
    (s === e.args && a === e.contentArgs) ||
      (e = new hr[e.typename](e.extName, e.prop, s, a));
  } else {
    ...
    c !== o &&
      ((e = new hr[e.typename](e.lineno, e.colno)),
...
function Ar(e, t, n) {
  var r = [],
    i = _r(n ? e[n] : e, function (e) {
      var n;
      return e instanceof hr.Block
        ? e
        : (((e instanceof hr.Filter && -1 !== je.indexOf(t, e.name.value)) ||
            e instanceof hr.CallExtensionAsync) &&
            ((n = new hr.Symbol(e.lineno, e.colno, Er())),
            r.push(new hr.FilterAsync(e.lineno, e.colno, e.name, e.args, n))),
          n);
    });
  return (
    n ? (e[n] = i) : (e = i),
    r.length ? (r.push(e), new hr.NodeList(e.lineno, e.colno, r)) : e
  );
}
function gr(e, t) {
  return (function (e) {
    return _r(e, function (e) {
      if (e instanceof hr.If || e instanceof hr.For) {
        ...
        if (
          (Tr(e, function (e) {
            if (
              e instanceof hr.FilterAsync ||
              e instanceof hr.IfAsync ||
              e instanceof hr.AsyncEach ||
              e instanceof hr.AsyncAll ||
              e instanceof hr.CallExtensionAsync
            )
              return ((t = !0), e);
          }),
        ...
        if (e instanceof hr.Block) {
          ...
          ((e.body = Tr(e.body, function (e) {
            if (e instanceof hr.FunCall && "super" === e.name.value)
              return ((t = !0), new hr.Symbol(e.lineno, e.colno, n));
          })),
            t &&
              e.body.children.unshift(
                new hr.Super(0, 0, e.name, new hr.Symbol(0, 0, n)),
              ));
        }
      });
    })(
...
var Nr = {
  ...
  Cr = Array.from,
  Ir =
    "function" == typeof Symbol && Symbol.iterator && "function" == typeof Cr,
  Sr = (function () {
    function e(e, t) {
...
var kr = {
  ...
  suppressValue: function (e, t) {
    return "object" == typeof (e = null != e ? e : "")
      ? new Lr(JSON.stringify(e).toString())
      : (!t || e instanceof Lr || (e = je.escape(e.toString())), e);
  },
  ensureDefined: function (e, t, n) {
    if (null == e)
      throw new je.TemplateError(
  ...
  fromIterator: function (e) {
    return "object" != typeof e || null === e || je.isArray(e)
      ? e
      : Ir && Symbol.iterator in e
        ? Cr(e)
        : e;
  },
};
...
var Dr = je.TemplateError,
    ...
    return (
      ...
      (i.compileSymbol = function (e, t) {
        ...
        r
          ? this._emit(r)
          : this._emit(
              'runtime.contextOrFrameLookup(context, frame, "' + n + '")',
            );
      }),
      ...
      (i.compilePair = function (e, t) {
        var n = e.key,
          r = e.value;
        (n instanceof hr.Symbol
          ? (n = new hr.Literal(n.lineno, n.colno, n.value))
          : (n instanceof hr.Literal && "string" == typeof n.value) ||
            this.fail(
      ...
      (i.compileSet = function (e, t) {
        ...
        (e.targets.forEach(function (e) {
          var i = e.value,
            s = t.lookup(i);
          (null == s && ((s = n._tmpid()), n._emitLine("var " + s + ";")),
            r.push(s));
        }),
          e.value
            ? (this._emit(r.join(" = ") + " = "),
      ...
      (i._compileMacro = function (e, t) {
        ...
        e.args.children.forEach(function (t, s) {
          s === e.args.children.length - 1 && t instanceof hr.Dict
            ? (i = t)
            : (n.assertType(t, hr.Symbol), r.push(t));
        });
        var o,
          c = [].concat(
            r.map(function (e) {
        ...
        (this._addScopeLevel(),
          ...
          e.names.children.forEach(function (e) {
            var i,
              s,
              a = n._tmpid();
            (e instanceof hr.Pair
              ? ((i = e.key.value), (s = e.value.value))
              : (s = i = e.value),
              n._emitLine(
              ...
              t.set(s, a),
              t.parent
                ? n._emitLine('frame.set("' + s + '", ' + a + ");")
                : n._emitLine('context.setVariable("' + s + '", ' + a + ");"));
          }));
      }),
  ...
  wr = Ke(function (e) {
    ...
    ((t.abs = Math.abs),
      ...
      (t.escape = function (e) {
        return e instanceof kr.SafeString
          ? e
          : ((e = null == e ? "" : e), kr.markSafe(je.escape(e.toString())));
      }),
      (t.safe = function (e) {
        return e instanceof kr.SafeString
          ? e
          : ((e = null == e ? "" : e), kr.markSafe(e.toString()));
      }),
      (t.first = function (e) {
        return e[0];
      }),
      ...
      (t.length = function (e) {
        ...
        return void 0 !== t
          ? ("function" == typeof Map && t instanceof Map) ||
            ...
            ? t.size
            : !je.isObject(t) || t instanceof kr.SafeString
              ? t.length
              : je.keys(t).length
          : 0;
      }),
      ...
      (t.replace = function (e, t, n, r) {
        ...
        if (
          ...
          return e;
        if ("" === t)
          return ((s = n + e.split("").join(n) + n), kr.copySafeness(e, s));
        var a = e.indexOf(t);
        if (0 === r || -1 === a) return e;
            ...
            s.sort(function (e, s) {
              ...
              return (
                !n &&
                  je.isString(o) &&
                  je.isString(c) &&
                  ((o = o.toLowerCase()), (c = c.toLowerCase())),
      ...
      (t.urlencode = function (e) {
        ...
        return je.isString(e)
          ? t(e)
          : (je.isArray(e) ? e : je._entries(e))
              .map(function (e) {
                var n = e[0],
                  r = e[1];
                return t(n) + "=" + t(r);
...
var Zr = { PrecompiledLoader: $r }.PrecompiledLoader,
  ei = (function (e) {
    function t(t, n) {
      var r;
      return (
        ...
        t
          ? ((t = Array.isArray(t) ? t : [t]),
            (r.searchPaths = t.map(Kr.normalize)))
          : (r.searchPaths = ["."]),
        r
      );
    }
    ...
    return (
      (n.init = function (e, t) {
        ...
        ((t = this.opts = t || {}),
          ...
          (this.loaders = []),
          e
            ? (this.loaders = je.isArray(e) ? e : [e])
            : oi
              ? (this.loaders = [new oi("views")])
              : ci && (this.loaders = [new ci("/views")]),
          "undefined" != typeof window &&
            window.jinja2Precompiled &&
            this.loaders.unshift(new li(window.jinja2Precompiled)),
          this._initLoaders(),
          (this.globals = ii()),
          (this.filters = {}),
          (this.tests = {}),
      ...
      (n.removeExtension = function (e) {
        ...
        t &&
          ((this.extensionsList = je.without(this.extensionsList, t)),
      ...
      (n.getTemplate = function (e, t, n, r, i) {
        ...
        if (
          (e && e.raw && (e = e.raw),
          je.isFunction(n) && ((i = n), (n = null), (t = t || !1)),
          je.isFunction(t) && ((i = t), (t = !1)),
          e instanceof _i)
        )
          c = e;
        else {
        ...
        return (
          je.asyncIter(
            ...
            function (n, o) {
              if (
                (o || n || r || (n = new Error("template not found: " + e)), n)
              ) {
  ...
  _i = (function (e) {
    ...
    return (
      (n.init = function (e, t, n, r) {
        if (((this.env = t || new mi()), je.isObject(e)))
          switch (e.type) {
            case "code":
      ...
      (n.render = function (e, t, n) {
        ...
        var c = null,
          l = !1;
        return (
          this.rootRenderFunc(this.env, a, o, kr, function (e, t) {
            if (!l || !n || void 0 === t)
              if (
                (e &&
                  ((e = je._prettifyError(r.path, r.env.opts.dev, e)),
                  (l = !0)),
                n)
              )
                i ? di(n, e, t) : n(e, t);
...
function Ci(e, t) {
  ...
  return (
    (t = t || {}),
    je.isObject(e) && ((t = e), (e = null)),
    ti.FileSystemLoader
      ? (n = new ti.FileSystemLoader(e, { watch: t.watch, noCache: t.noCache }))
      : ti.WebLoader &&
        (n = new ti.WebLoader(e, {
...
function Oi(e, t) {
  return bi(
    ...
    (function (e, t) {
      ...
      : e,
    Si(
      Si(Si({}, n), null == this ? void 0 : this._options),
      i(null != t ? t : {}),
    ),
  );
}
function yi(e) {
  return bi(this, e, Si(Si({}, this._options), { xmlMode: !0 }));
}
function Li(e) {
...
function Ui(e) {
  ...
  return (
    ((n >= Pi.LowerA && n <= Pi.LowerZ) ||
      (n >= Pi.UpperA && n <= Pi.UpperZ) ||
      n === Pi.Exclamation) &&
    e.includes(">", t + 2)
  );
}
...
function Qi(e, t, n, r) {
  t in e
    ? (e[t] = n)
    : Vi(e, t, !r && qi.test(t) ? (n ? "" : null) : "".concat(n));
}
function Xi(e, t, n) {
  var r,
    i = e;
  ((null !== (r = i.data) && void 0 !== r) || (i.data = {}),
    "object" == typeof t
      ...
      : "string" == typeof t && void 0 !== n && (i.data[t] = n));
}
function $i(e, t) {
  var n, r, i, s;
  null == t
    ? (r = (n = Object.keys(e.attribs).filter(function (e) {
    ...
    : ((n = ["data-" + ((s = t), s.replace(/[A-Z]/g, "-$&").toLowerCase())]),
      (r = [t]));
        ...
        switch (e) {
          ...
          case "src":
            ...
            return "undefined" == typeof URL ||
              ...
              ? o
              : new URL(o, this.options.baseURI).href;
          case "innerText":
            return J(i);
          case "textContent":
            return z(i);
          ...
          return Bi(this, function (n, i) {
            I(n) &&
              Qi(
                n,
                e,
                t.call(n, i, Wi(n, e, r.options.xmlMode)),
                r.options.xmlMode,
              );
          });
        }
...
function fs(e, t, n) {
  ...
  function l(e) {
    r.length > 0 && r[r.length - 1].type === Zi.Descendant
      ? (r[r.length - 1].type = e)
      : (c(), r.push({ type: e }));
  }
  function h(e, t) {
  ...
  function u() {
    if (
      (r.length && r[r.length - 1].type === Zi.Descendant && r.pop(),
      0 === r.length)
    )
  ...
  e: for (; n < t.length; ) {
    ...
    switch (e) {
      ...
      case 12:
      case 13:
        ((0 !== r.length && r[0].type === Zi.Descendant) ||
          (c(), r.push({ type: Zi.Descendant })),
          s(1));
        break;
      case 62:
        (l(Zi.Child), s(1));
        ...
        if ("exists" !== c) {
          if (hs(t.charCodeAt(n))) {
            ...
            for (
              ;
              n < t.length &&
              ((!us(t.charCodeAt(n)) && 93 !== t.charCodeAt(n)) || o(n));
            )
              n += 1;
            h = ls(t.slice(e, n));
          }
      ...
      case 58: {
        ...
        if (40 === t.charCodeAt(n))
          if (ss.has(e)) {
            ...
            if (((s = []), (n = fs(s, t, n + 1)), 41 !== t.charCodeAt(n)))
        ...
        r.push({ type: Zi.Pseudo, name: e, data: s });
        break;
      }
      case 44:
        (u(), (r = []), s(1));
      ...
      default: {
        ...
        (124 === t.charCodeAt(n) &&
          ...
          r.push(
            "*" === a
              ? { type: Zi.Universal, namespace: o }
              : { type: Zi.Tag, name: a, namespace: o },
          ));
      }
    }
  }
...
function gs(e) {
  ...
  return (
    e.type === Zi.Attribute
      ? ((r = null !== (n = _s.get(e.action)) && void 0 !== n ? n : 4),
        ...
        (e.data
          ? "has" === e.name || "contains" === e.name
            ...
            : Array.isArray(e.data)
              ? ((r = Math.min(...e.data.map((e) => Math.min(...e.map(gs))))),
                r < 0 && (r = 0))
              : (r = 2)
          : (r = 3)),
    r
    ...
    return Ss(t, n)
      ? ((s = s.toLowerCase()),
        (t) => {
          ...
          return (
            null != n && n.length === s.length && n.toLowerCase() === s && e(t)
          );
        })
    ...
    return 0 === a
      ...
      : Ss(t, n)
        ...
        : (t) => {
            var n;
            return (
              !!(null === (n = r.getAttributeValue(t, i)) || void 0 === n
                ? void 0
                : n.startsWith(s)) && e(t)
            );
          };
...
var Os = Ke(function (e, t) {
  ...
  t.parse = function (e) {
    ...
    function l() {
      for (
        var n = t, s = 0;
        t < e.length && e.charCodeAt(t) >= r && e.charCodeAt(t) <= i;
      )
        ((s = 10 * s + (e.charCodeAt(t) - r)), t++);
      return t === n ? null : s;
    }
    function h() {
...
function js(e) {
  return (
    e.type === Zi.Pseudo &&
    ("scope" === e.name ||
      (Array.isArray(e.data) && e.data.some((e) => e.some(js))))
  );
}
const Vs = { type: Zi.Descendant },
  Ws = { type: "_flexibleDescendant" },
  Qs = { type: Zi.Pseudo, name: "scope", data: null };
function Xs(e, t, n) {
  var r;
  ...
  const o = e
    .map((e) => {
      if (e.length >= 2) {
        ...
        t.type !== Zi.Pseudo ||
          "scope" !== t.name ||
          (i && n.type === Zi.Descendant
            ? (e[1] = Ws)
            : (n.type !== Zi.Adjacent && n.type !== Zi.Sibling) || (a = !0));
      }
      return (function (e, t, n) {
        var r;
        return e.reduce(
          (e, r) => (e === ds.falseFunc ? ds.falseFunc : Ks(e, r, t, n, Xs)),
          null !== (r = t.rootFunc) && void 0 !== r ? r : ds.trueFunc,
        );
      })(e, t, s);
    })
...
function $s(e, t) {
  return t === ds.falseFunc || e === ds.trueFunc
    ? e
    : e === ds.falseFunc || t === ds.trueFunc
      ? t
      : function (n) {
          return e(n) || t(n);
        };
...
const Zs =
  ...
  function (e, t, n) {
    const r = (function (e) {
      ...
      const s = null != e ? e : Js;
      return (
        (null !== (t = s.adapter) && void 0 !== t) || (s.adapter = Se),
        (null !== (n = s.equals) && void 0 !== n) ||
          (s.equals =
            null !==
              (i =
                null === (r = s.adapter) || void 0 === r ? void 0 : r.equals) &&
            void 0 !== i
              ? i
              : zs),
        s
...
const sa = { type: Zi.Universal, namespace: null },
  aa = { type: Zi.Pseudo, name: "scope", data: null };
function oa(e, t, n = {}) {
  return ca([e], t, n);
}
function ca(e, t, n = {}) {
  ...
  const [r, i] = ia(ps(t));
  return (
    (r.length > 0 && e.some(Zs(r, n))) || i.some((t) => ua(t, e, n).length > 0)
  );
}
function la(e, t, n = {}) {
  return ha(ps(e), t, n);
...
function pa(e, t, n, r, i) {
  ...
  if (f) {
    ...
    n = { ...n, relativeSelector: !1, rootFunc: (e) => u.includes(e) };
    ...
    i = _a(function (e, t) {
      ...
      return (
        Bi(t, function (t) {
          for (
            var i;
            (i = e(t)) && !(null == r ? void 0 : r(i, n.length));
            t = i
          )
            n.push(i);
        }),
...
var wa = Object.freeze({
  ...
  index: function (e) {
    ...
    return (
      null == e
        ? ((t = this.parent().children()), (n = this[0]))
        : "string" == typeof e
          ? ((t = this._make(e)), (n = this[0]))
          : ((t = this), (n = wi(e) ? e[0] : e)),
...
function Ha(e, t, n, r, i) {
  for (
    ...
    ((u.parent = i),
      u.prev &&
        (u.prev.next = null !== (s = u.next) && void 0 !== s ? s : null),
      u.next &&
        (u.next.prev = null !== (a = u.prev) && void 0 !== a ? a : null),
      (u.prev = 0 === h ? c : r[h - 1]),
...
var Va = Object.freeze({
  ...
  remove: function (e) {
    return (
      Bi(e ? this.filter(e) : this, function (e) {
      ...
      return this.map(function (t, n) {
        ...
        .map(function (t, n) {
          ...
          return Array.isArray(a)
            ? a.map(function (e) {
                return { name: s, value: e.replace(za, "\r\n") };
              })
...
class mo {
  ...
  _processSurrogate(e) {
    if (this.pos !== this.html.length - 1) {
      ...
      return ((this.endOfChunkHit = !0), io.EOF);
  ...
  peek(e) {
    ...
    return t >= this.html.length
      ? ((this.endOfChunkHit = !this.lastChunkWritten), io.EOF)
  ...
  advance() {
    if (
      ...
      return ((this.endOfChunkHit = !this.lastChunkWritten), io.EOF);
    let e = this.html.charCodeAt(this.pos);
    if (e === io.CARRIAGE_RETURN)
      return ((this.isEol = !0), (this.skipNextNewLine = !0), io.LINE_FEED);
    if (e === io.LINE_FEED && ((this.isEol = !0), this.skipNextNewLine))
      return (
        this.line--,
        (this.skipNextNewLine = !1),
        this._addGap(),
  ...
  _checkForProblematicCharacters(e) {
    po(e)
      ? this._err(Eo.controlCharacterInInputStream)
      : fo(e) && this._err(Eo.noncharacterInInputStream);
  }
  retreat(e) {
    ...
    function l(e) {
      return function (t, n) {
        for (var r = "", i = 0, c = 0; (c = t.indexOf("&", c)) >= 0; )
          if (
            ((r += t.slice(i, c)), (i = c), (c += 1), t.charCodeAt(c) !== a.NUM)
          ) {
            for (
              var l = 0, u = 1, p = 0, f = e[p];
              c < t.length && !((p = h(e, f, p + 1, t.charCodeAt(c))) < 0);
              c++, u++
            ) {
              ...
              if (d) {
                var E;
                if (
                  ((n && t.charCodeAt(c) !== a.SEMI) || ((l = p), (u = 0)),
                  0 === (E = (d >> 14) - 1))
                )
                  break;
                p += E;
            ...
            if (0 !== l)
              ((r +=
                1 === (E = (e[l] & o.VALUE_LENGTH) >> 14)
                  ? String.fromCharCode(e[l] & ~o.VALUE_LENGTH)
                  : 2 === E
                    ? String.fromCharCode(e[l + 1])
                    : String.fromCharCode(e[l + 1], e[l + 2])),
                (i = c - u + 1));
          } else {
            var m = c + 1,
              T = 10,
              _ = t.charCodeAt(m);
            (_ | a.To_LOWER_BIT) === a.LOWER_X &&
              ((T = 16), (c += 1), (m += 1));
            do {
              _ = t.charCodeAt(++c);
            } while (
              (_ >= a.ZERO && _ <= a.NINE) ||
              (16 === T &&
                (_ | a.To_LOWER_BIT) >= a.LOWER_A &&
                (_ | a.To_LOWER_BIT) <= a.LOWER_F)
            );
            if (m !== c) {
...
class tc {
  ...
  emitCurrentTagToken() {
    ...
    (this.prepareToken(e),
      ...
      e.type === To.START_TAG
        ...
        : (e.attrs.length > 0 && this._err(Eo.endTagWithAttributes),
  ...
  _emitEOFToken() {
    ...
    (e &&
      ...
      this.handler.onEof({ type: To.EOF, location: e }),
      (this.active = !1));
  }
    ...
    for (
      ...
      if (o) {
        ...
        if (
          ...
          ((i = this.preprocessor.peek(1)) === io.EQUALS_SIGN || Xo(i))
            ? ((t = [io.AMPERSAND]), (s += a))
            : ((t =
                0 === a
                  ? [wo[s] & ~yo.VALUE_LENGTH]
                  : 1 === a
                    ? [wo[++s]]
                    : [wo[++s], wo[++s]]),
              (n = 0),
  ...
  _stateRcdataLessThanSign(e) {
    e === io.SOLIDUS
      ? (this.state = Ko.RCDATA_END_TAG_OPEN)
      : (this._emitChars("<"), (this.state = Ko.RCDATA), this._stateRcdata(e));
  }
  _stateRcdataEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.RCDATA_END_TAG_NAME), this._stateRcdataEndTagName(e))
      : (this._emitChars("</"), (this.state = Ko.RCDATA), this._stateRcdata(e));
  }
  ...
  _stateRawtextLessThanSign(e) {
    e === io.SOLIDUS
      ? (this.state = Ko.RAWTEXT_END_TAG_OPEN)
      : (this._emitChars("<"),
  ...
  _stateRawtextEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.RAWTEXT_END_TAG_NAME),
        this._stateRawtextEndTagName(e))
      : (this._emitChars("</"),
        (this.state = Ko.RAWTEXT),
        this._stateRawtext(e));
  ...
  _stateRawtextEndTagName(e) {
    this.handleSpecialEndTag(e) &&
      (this._emitChars("</"), (this.state = Ko.RAWTEXT), this._stateRawtext(e));
  }
  ...
  _stateScriptDataEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.SCRIPT_DATA_END_TAG_NAME),
        this._stateScriptDataEndTagName(e))
      : (this._emitChars("</"),
        (this.state = Ko.SCRIPT_DATA),
        this._stateScriptData(e));
  ...
  _stateScriptDataEscapeStart(e) {
    e === io.HYPHEN_MINUS
      ? ((this.state = Ko.SCRIPT_DATA_ESCAPE_START_DASH), this._emitChars("-"))
      : ((this.state = Ko.SCRIPT_DATA), this._stateScriptData(e));
  }
  ...
  _stateScriptDataEscapedLessThanSign(e) {
    e === io.SOLIDUS
      ? (this.state = Ko.SCRIPT_DATA_ESCAPED_END_TAG_OPEN)
      : Qo(e)
        ? (this._emitChars("<"),
  ...
  _stateScriptDataEscapedEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.SCRIPT_DATA_ESCAPED_END_TAG_NAME),
        this._stateScriptDataEscapedEndTagName(e))
      : (this._emitChars("</"),
        (this.state = Ko.SCRIPT_DATA_ESCAPED),
        this._stateScriptDataEscaped(e));
  ...
  _stateScriptDataDoubleEscapeStart(e) {
    if (
      this.preprocessor.startsWith(co, !1) &&
      ec(this.preprocessor.peek(co.length))
    ) {
      this._emitCodePoint(e);
  ...
  _stateScriptDataDoubleEscapedLessThanSign(e) {
    e === io.SOLIDUS
      ? ((this.state = Ko.SCRIPT_DATA_DOUBLE_ESCAPE_END), this._emitChars("/"))
      : ((this.state = Ko.SCRIPT_DATA_DOUBLE_ESCAPED),
        this._stateScriptDataDoubleEscaped(e));
  }
  ...
  _stateMarkupDeclarationOpen(e) {
    this._consumeSequenceIfMatch(so, !0)
      ? (this._createCommentToken(so.length + 1),
        (this.state = Ko.COMMENT_START))
      : this._consumeSequenceIfMatch(oo, !1)
        ? ((this.currentLocation = this.getCurrentLocation(oo.length + 1)),
          (this.state = Ko.DOCTYPE))
        : this._consumeSequenceIfMatch(ao, !0)
          ? this.inForeignNode
            ? (this.state = Ko.CDATA_SECTION)
            : (this._err(Eo.cdataInHtmlContent),
              this._createCommentToken(ao.length + 1),
              (this.currentToken.data = "[CDATA["),
              (this.state = Ko.BOGUS_COMMENT))
          : this._ensureHibernation() ||
            (this._err(Eo.incorrectlyOpenedComment),
            this._createCommentToken(2),
            (this.state = Ko.BOGUS_COMMENT),
            this._stateBogusComment(e));
  }
  ...
  _stateCommentLessThanSignBang(e) {
    e === io.HYPHEN_MINUS
      ? (this.state = Ko.COMMENT_LESS_THAN_SIGN_BANG_DASH)
      : ((this.state = Ko.COMMENT), this._stateComment(e));
  }
  _stateCommentLessThanSignBangDash(e) {
    e === io.HYPHEN_MINUS
      ? (this.state = Ko.COMMENT_LESS_THAN_SIGN_BANG_DASH_DASH)
      : ((this.state = Ko.COMMENT_END_DASH), this._stateCommentEndDash(e));
  }
  ...
  _stateAfterDoctypeName(e) {
    ...
    switch (e) {
      ...
      case io.EOF:
        ...
        break;
      default:
        this._consumeSequenceIfMatch(lo, !1)
          ? (this.state = Ko.AFTER_DOCTYPE_PUBLIC_KEYWORD)
          : this._consumeSequenceIfMatch(ho, !1)
            ? (this.state = Ko.AFTER_DOCTYPE_SYSTEM_KEYWORD)
            : this._ensureHibernation() ||
              (this._err(Eo.invalidCharacterSequenceAfterDoctypeName),
              (t.forceQuirks = !0),
  ...
  _stateAfterDoctypePublicIdentifier(e) {
    ...
    switch (e) {
      ...
      case io.QUOTATION_MARK:
        (this._err(
          Eo.missingWhitespaceBetweenDoctypePublicAndSystemIdentifiers,
        ),
          (t.systemId = ""),
  ...
  _stateCdataSectionBracket(e) {
    e === io.RIGHT_SQUARE_BRACKET
      ? (this.state = Ko.CDATA_SECTION_END)
      : (this._emitChars("]"),
        (this.state = Ko.CDATA_SECTION),
        this._stateCdataSection(e));
  }
  ...
  _stateCharacterReference(e) {
    e === io.NUMBER_SIGN
      ? (this.state = Ko.NUMERIC_CHARACTER_REFERENCE)
      : Xo(e)
        ? ((this.state = Ko.NAMED_CHARACTER_REFERENCE),
          this._stateNamedCharacterReference(e))
  ...
  _stateAmbiguousAmpersand(e) {
    Xo(e)
      ...
      : (e === io.SEMICOLON && this._err(Eo.unknownNamedCharacterReference),
        this._reconsumeInState(this.returnState, e));
  }
  _stateNumericCharacterReference(e) {
    ((this.charRefCode = 0),
      e === io.LATIN_SMALL_X || e === io.LATIN_CAPITAL_X
        ? (this.state = Ko.HEXADEMICAL_CHARACTER_REFERENCE_START)
        : Vo(e)
          ? ((this.state = Ko.DECIMAL_CHARACTER_REFERENCE),
            this._stateDecimalCharacterReference(e))
          : (this._err(Eo.absenceOfDigitsInNumericCharacterReference),
            this._flushCodePointConsumedAsCharacterReference(io.AMPERSAND),
  ...
  _stateHexademicalCharacterReferenceStart(e) {
    !(function (e) {
      ...
      ? (this._err(Eo.absenceOfDigitsInNumericCharacterReference),
        ...
        this._unconsume(2),
        (this.state = this.returnState))
      : ((this.state = Ko.HEXADEMICAL_CHARACTER_REFERENCE),
        this._stateHexademicalCharacterReference(e));
  }
...
class hc {
  ...
  _isInTemplate() {
    return (
      this.currentTagId === Po.TEMPLATE &&
      this.treeAdapter.getNamespaceURI(this.current) === vo.HTML
    );
  }
  ...
  popUntilTagNamePopped(e) {
    ...
    do {
      ...
      t > 0 &&
      this.treeAdapter.getNamespaceURI(this.items[t]) !== vo.HTML
    );
  ...
  tryPeekProperlyNestedBodyElement() {
    return this.stackTop >= 1 && this.tagIDs[1] === Po.BODY
      ? this.items[1]
      : null;
  }
  contains(e) {
...
class fc {
  ...
  pushElement(e, t) {
    (this._ensureNoahArkCondition(e),
      this.entries.unshift({ type: uc.Element, element: e, token: t }));
  }
  insertElementAfterBookmark(e, t) {
    const n = this.entries.indexOf(this.bookmark);
    this.entries.splice(n, 0, { type: uc.Element, element: e, token: t });
  }
  removeEntry(e) {
  ...
  getElementEntryInScopeWithTagName(e) {
    const t = this.entries.find(
      (t) =>
        t.type === uc.Marker || this.treeAdapter.getTagName(t.element) === e,
    );
...
const Cc = "text/html",
  ...
  bc = new Map([
    [
      "xlink:actuate",
      { prefix: "xlink", name: "actuate", namespace: vo.XLINK },
    ],
    [
      "xlink:arcrole",
      { prefix: "xlink", name: "arcrole", namespace: vo.XLINK },
    ],
    ["xlink:href", { prefix: "xlink", name: "href", namespace: vo.XLINK }],
    ["xlink:role", { prefix: "xlink", name: "role", namespace: vo.XLINK }],
    ["xlink:show", { prefix: "xlink", name: "show", namespace: vo.XLINK }],
    ["xlink:title", { prefix: "xlink", name: "title", namespace: vo.XLINK }],
    ["xlink:type", { prefix: "xlink", name: "type", namespace: vo.XLINK }],
    ["xml:base", { prefix: "xml", name: "base", namespace: vo.XML }],
    ["xml:lang", { prefix: "xml", name: "lang", namespace: vo.XML }],
    ["xml:space", { prefix: "xml", name: "space", namespace: vo.XML }],
    ["xmlns", { prefix: "", name: "xmlns", namespace: vo.XMLNS }],
    ["xmlns:xlink", { prefix: "xmlns", name: "xlink", namespace: vo.XMLNS }],
  ]),
  Oc = new Map(
    [
      "altGlyph",
  ...
  return (
    ((!r || r === vo.HTML) &&
      (function (e, t, n) {
        ...
        return (
          t === vo.SVG &&
          (e === Po.FOREIGN_OBJECT || e === Po.DESC || e === Po.TITLE)
        );
      })(e, t, n)) ||
    ((!r || r === vo.MATHML) &&
      (function (e, t) {
...
class wc {
  constructor(e, t, n = null, r = null) {
    ((this.fragmentContext = n),
      ...
      (this.fragmentContextID = n
        ? Fo(this.treeAdapter.getTagName(n))
        : Po.UNKNOWN),
  ...
  static getFragmentParser(e, t) {
    ...
    const r = n.treeAdapter.createElement("documentmock", vo.HTML, []),
      i = new this(n, r, e);
    return (
      i.fragmentContextID === Po.TEMPLATE &&
        i.tmplInsertionModeStack.unshift(Rc.IN_TEMPLATE),
  ...
  _setContextModes(e, t) {
    const n =
      e === this.document || this.treeAdapter.getNamespaceURI(e) === vo.HTML;
  ...
  _initTokenizerForFragmentParsing() {
    if (
      this.fragmentContext &&
      this.treeAdapter.getNamespaceURI(this.fragmentContext) === vo.HTML
    )
  ...
  shouldProcessStartTagTokenInForeignContent(e) {
    ...
    return (
      ...
      (e.tagID !== Po.SVG ||
        this.treeAdapter.getTagName(t) !== Mo.ANNOTATION_XML ||
        this.treeAdapter.getNamespaceURI(t) !== vo.MATHML) &&
        (this.tokenizer.inForeignNode ||
          ((e.tagID === Po.MGLYPH || e.tagID === Po.MALIGNMARK) &&
            !this._isIntegrationPoint(n, t, vo.HTML)))
    );
  }
  _processToken(e) {
    switch (e.type) {
  ...
  _reconstructActiveFormattingElements() {
    ...
    if (e) {
      const t = this.activeFormattingElements.entries.findIndex(
        (e) => e.type === uc.Marker || this.openElements.contains(e.element),
      );
  ...
  onStartTag(e) {
    ((this.skipNextNewLine = !1),
      ...
      e.selfClosing &&
        !e.ackSelfClosing &&
        this._err(e, Eo.nonVoidHtmlElementStartTagWithTrailingSolidus));
  }
  _processStartTag(e) {
            ...
            (function (e) {
              ...
              return (
                (t === Po.FONT &&
                  e.attrs.some(
                    ({ name: e }) =>
                      e === Do.COLOR || e === Do.SIZE || e === Do.FACE,
                  )) ||
                yc.has(t)
              );
            })(t)
  ...
  _startTagOutsideForeignContent(e) {
    switch (this.insertionMode) {
      ...
      case Rc.BEFORE_HTML:
        !(function (e, t) {
          t.tagID === Po.HTML
            ? (e._insertElement(t, vo.HTML), (e.insertionMode = Rc.BEFORE_HEAD))
            : Wc(e, t);
        })(this, e);
        break;
      case Rc.BEFORE_HEAD:
      ...
      case Rc.IN_CAPTION:
        !(function (e, t) {
          const n = t.tagID;
          _l.has(n)
            ? e.openElements.hasInTableScope(Po.CAPTION) &&
      ...
      case Rc.IN_CELL:
        !(function (e, t) {
          const n = t.tagID;
          _l.has(n)
            ? (e.openElements.hasInTableScope(Po.TD) ||
                e.openElements.hasInTableScope(Po.TH)) &&
              (e._closeTableCell(), Il(e, t))
            : ol(e, t);
        })(this, e);
        break;
      case Rc.IN_SELECT:
      ...
      case Rc.IN_SELECT_IN_TABLE:
        !(function (e, t) {
          ...
          n === Po.TD ||
          n === Po.TH
            ? (e.openElements.popUntilTagNamePopped(Po.SELECT),
      ...
      this.currentNotInHTML
        ? (function (e, t) {
            if (t.tagID === Po.P || t.tagID === Po.BR)
              return (Dl(e), void e._endTagOutsideForeignContent(t));
  ...
  _endTagOutsideForeignContent(e) {
    switch (this.insertionMode) {
      ...
      case Rc.BEFORE_HTML:
        !(function (e, t) {
          const n = t.tagID;
          (n !== Po.HTML && n !== Po.HEAD && n !== Po.BODY && n !== Po.BR) ||
            Wc(e, t);
        })(this, e);
        break;
      case Rc.BEFORE_HEAD:
        !(function (e, t) {
          const n = t.tagID;
          n === Po.HEAD || n === Po.BODY || n === Po.HTML || n === Po.BR
            ? Qc(e, t)
      ...
      case Rc.IN_COLUMN_GROUP:
        !(function (e, t) {
          switch (t.tagID) {
            case Po.COLGROUP:
              e.openElements.currentTagId === Po.COLGROUP &&
                (e.openElements.pop(), (e.insertionMode = Rc.IN_TABLE));
              break;
            case Po.TEMPLATE:
              $c(e, t);
              break;
      ...
      case Rc.IN_FRAMESET:
        !(function (e, t) {
          t.tagID !== Po.FRAMESET ||
            ...
            (e.openElements.pop(),
            e.fragmentContext ||
              e.openElements.currentTagId === Po.FRAMESET ||
              (e.insertionMode = Rc.AFTER_FRAMESET));
        })(this, e);
        break;
      case Rc.AFTER_FRAMESET:
        !(function (e, t) {
  ...
  onWhitespaceCharacter(e) {
    if (
      ...
      ((this.skipNextNewLine = !1), e.chars.charCodeAt(0) === io.LINE_FEED)
    ) {
...
function $c(e, t) {
  e.openElements.tmplCount > 0
    ? (e.openElements.generateImpliedEndTagsThoroughly(),
      e.openElements.currentTagId !== Po.TEMPLATE &&
        e._err(t, Eo.closingOfElementWithOpenChildElements),
...
function Jc(e, t) {
  const n =
    t.type === To.EOF
      ? Eo.openElementsLeftAfterEof
      : Eo.disallowedContentInNoscriptInHead;
  (e._err(t, n),
    e.openElements.pop(),
    (e.insertionMode = Rc.IN_HEAD),
    e._processToken(t));
...
function ol(e, t) {
  switch (t.tagID) {
    ...
    case Po.DT:
      !(function (e, t) {
        ...
        for (let t = e.openElements.stackTop; t >= 0; t--) {
          ...
          if (
            (n === Po.LI && r === Po.LI) ||
            ((n === Po.DD || n === Po.DT) && (r === Po.DD || r === Po.DT))
          ) {
    ...
    case Po.RTC:
      !(function (e, t) {
        (e.openElements.hasInScope(Po.RUBY) &&
          e.openElements.generateImpliedEndTags(),
          e._insertElement(t, vo.HTML));
      })(e, t);
      break;
    ...
    case Po.RP:
      !(function (e, t) {
        (e.openElements.hasInScope(Po.RUBY) &&
          e.openElements.generateImpliedEndTagsWithExclusion(Po.RTC),
          e._insertElement(t, vo.HTML));
      })(e, t);
      break;
    case Po.PRE:
    ...
    case Po.SVG:
      !(function (e, t) {
        (e._reconstructActiveFormattingElements(),
          ...
          vc(t),
          t.selfClosing
            ? e._appendElement(t, vo.SVG)
            : e._insertElement(t, vo.SVG),
          (t.ackSelfClosing = !0));
      })(e, t);
      break;
    case Po.HTML:
    ...
    case Po.NOBR:
      !(function (e, t) {
        (e._reconstructActiveFormattingElements(),
          e.openElements.hasInScope(Po.NOBR) &&
            (qc(e, t), e._reconstructActiveFormattingElements()),
          e._insertElement(t, vo.HTML),
          e.activeFormattingElements.pushElement(e.openElements.current, t));
      })(e, t);
      break;
    case Po.MATH:
      !(function (e, t) {
        (e._reconstructActiveFormattingElements(),
          ...
          vc(t),
          t.selfClosing
            ? e._appendElement(t, vo.MATHML)
            : e._insertElement(t, vo.MATHML),
          (t.ackSelfClosing = !0));
      })(e, t);
      break;
    case Po.TABLE:
      !(function (e, t) {
        (e.treeAdapter.getDocumentMode(e.document) !== Ro.QUIRKS &&
          e.openElements.hasInButtonScope(Po.P) &&
          e._closePElement(),
          e._insertElement(t, vo.HTML),
          (e.framesetOk = !1),
          (e.insertionMode = Rc.IN_TABLE));
    ...
    case Po.BUTTON:
      !(function (e, t) {
        (e.openElements.hasInScope(Po.BUTTON) &&
          (e.openElements.generateImpliedEndTags(),
...
function ll(e, t) {
  switch (t.tagID) {
    ...
    case Po.P:
      !(function (e) {
        (e.openElements.hasInButtonScope(Po.P) ||
          e._insertFakeElement(Mo.P, Po.P),
          e._closePElement());
      })(e);
      break;
    case Po.DL:
    ...
    case Po.LI:
      !(function (e) {
        e.openElements.hasInListItemScope(Po.LI) &&
          (e.openElements.generateImpliedEndTagsWithExclusion(Po.LI),
    ...
    case Po.BODY:
      !(function (e, t) {
        if (
          e.openElements.hasInScope(Po.BODY) &&
          ((e.insertionMode = Rc.AFTER_BODY), e.options.sourceCodeLocationInfo)
        ) {
          const n = e.openElements.tryPeekProperlyNestedBodyElement();
    ...
    case Po.HTML:
      !(function (e, t) {
        e.openElements.hasInScope(Po.BODY) &&
          ((e.insertionMode = Rc.AFTER_BODY), Ll(e, t));
      })(e, t);
      break;
    case Po.FORM:
      !(function (e) {
        ...
        (t || (e.formElement = null),
          (n || t) &&
            e.openElements.hasInScope(Po.FORM) &&
            (e.openElements.generateImpliedEndTags(),
            t
              ? e.openElements.popUntilTagNamePopped(Po.FORM)
...
function pl(e, t) {
  switch (t.tagID) {
    ...
    case Po.TABLE:
      !(function (e, t) {
        e.openElements.hasInTableScope(Po.TABLE) &&
          (e.openElements.popUntilTagNamePopped(Po.TABLE),
          e._resetInsertionMode(),
          e._processStartTag(t));
      })(e, t);
      break;
...
function gl(e, t) {
  e.openElements.currentTagId === Po.COLGROUP &&
    (e.openElements.pop(), (e.insertionMode = Rc.IN_TABLE), e._processToken(t));
}
function Nl(e, t) {
  switch (t.tagID) {
    case Po.TR:
...
function Il(e, t) {
  switch (t.tagID) {
    ...
    case Po.THEAD:
    case Po.TR:
      e.openElements.hasInTableScope(Po.TR) &&
        (e.openElements.clearBackToTableRowContext(),
        e.openElements.pop(),
        (e.insertionMode = Rc.IN_TABLE_BODY),
        Nl(e, t));
...
function bl(e, t) {
  switch (t.tagID) {
    ...
    case Po.TEXTAREA:
    case Po.SELECT:
      e.openElements.hasInSelectScope(Po.SELECT) &&
        (e.openElements.popUntilTagNamePopped(Po.SELECT),
        e._resetInsertionMode(),
  ...
  switch (t.tagID) {
    case Po.OPTGROUP:
      (e.openElements.stackTop > 0 &&
        e.openElements.currentTagId === Po.OPTION &&
        e.openElements.tagIDs[e.openElements.stackTop - 1] === Po.OPTGROUP &&
        e.openElements.pop(),
        e.openElements.currentTagId === Po.OPTGROUP && e.openElements.pop());
      break;
    case Po.OPTION:
...
function Ll(e, t) {
  ...
  if (t.tagID === Po.HTML) {
    if (
      (e.fragmentContext || (e.insertionMode = Rc.AFTER_AFTER_BODY),
...
function Dl(e) {
  for (
    ;
    e.treeAdapter.getNamespaceURI(e.openElements.current) !== vo.HTML &&
  ...
  function r(e) {
    for (var r, i = "", s = 0; null !== (r = t.xmlReplacer.exec(e)); ) {
      var a = r.index,
        ...
        c = n.get(o);
      void 0 !== c
        ? ((i += e.substring(s, a) + c), (s = a + 1))
        : ((i += ""
            .concat(e.substring(s, a), "&#x")
...
const wl = { treeAdapter: Ec, scriptingEnabled: !0 };
function Bl(e, t) {
  return Fl(e, { ...wl, ...t });
}
function Fl(e, t) {
  return t.treeAdapter.isElementNode(e)
        ...
        return `<${n}${(function (e, { treeAdapter: t }) {
          ...
          (function (e, t) {
            return (
              ...
              t.treeAdapter.getNamespaceURI(e) === vo.HTML &&
              xl.has(t.treeAdapter.getTagName(e))
            );
          })(e, t)
            ? ""
            : `${(function (e, t) {
                ...
                const r =
                    t.treeAdapter.isElementNode(e) &&
                    t.treeAdapter.getTagName(e) === Mo.TEMPLATE &&
                    t.treeAdapter.getNamespaceURI(e) === vo.HTML
    ...
    : t.treeAdapter.isTextNode(e)
      ? (function (e, t) {
          ...
          return s &&
            n.getNamespaceURI(i) === vo.HTML &&
            ((a = s),
            (o = t.scriptingEnabled),
            Yo.has(a) || (o && a === Mo.NOSCRIPT))
            ? r
            : Ml(r);
          var a, o;
        })(e, t)
...
const Gl = {
  ...
  createDocument() {
    const e = new N([]);
    return ((e["x-mode"] = Ro.NO_QUIRKS), e);
  },
  ...
  setDocumentType(e, t, n, r) {
    ...
    (s
      ...
      : ((s = new _("!doctype", i)), Gl.appendChild(e, s)),
...
class Jl {
  ...
  stateText(e) {
    e === Kl.Lt || (!this.decodeEntities && this.fastForwardTo(Kl.Lt))
      ? (this.index > this.sectionStart &&
          this.cbs.ontext(this.sectionStart, this.index),
        (this.state = jl.BeforeTagName),
        (this.sectionStart = this.index))
      : this.decodeEntities && e === Kl.Amp && (this.state = jl.BeforeEntity);
  }
  ...
  stateInSpecialTag(e) {
    ...
    (32 | e) === this.currentSequence[this.sequenceIndex]
      ...
      : 0 === this.sequenceIndex
        ? this.currentSequence === zl.TitleEnd
          ? this.decodeEntities &&
            e === Kl.Amp &&
            (this.state = jl.BeforeEntity)
          : this.fastForwardTo(Kl.Lt) && (this.sequenceIndex = 1)
        : (this.sequenceIndex = Number(e === Kl.Lt));
  }
  stateCDATASequence(e) {
    e === zl.Cdata[this.sequenceIndex]
      ? ++this.sequenceIndex === zl.Cdata.length &&
  ...
  isTagStartChar(e) {
    return this.xmlMode
      ...
      : (function (e) {
          return (
            (e >= Kl.LowerA && e <= Kl.LowerZ) ||
            (e >= Kl.UpperA && e <= Kl.UpperZ)
          );
        })(e);
  }
  startSpecial(e, t) {
  ...
  stateBeforeTagName(e) {
    if (e === Kl.ExclamationMark)
      ...
      const t = 32 | e;
      ((this.sectionStart = this.index),
        this.xmlMode || t !== zl.TitleEnd[2]
          ? (this.state =
              this.xmlMode || t !== zl.ScriptEnd[2]
                ? jl.InTagName
                : jl.BeforeSpecialS)
          : this.startSpecial(zl.TitleEnd, 3));
    } else
      e === Kl.Slash
        ? (this.state = jl.BeforeClosingTagName)
        : ((this.state = jl.Text), this.stateText(e));
  }
  stateInTagName(e) {
    Xl(e) &&
  ...
  stateAfterClosingTagName(e) {
    (e === Kl.Gt || this.fastForwardTo(Kl.Gt)) &&
      ((this.state = jl.Text), (this.sectionStart = this.index + 1));
  }
  stateBeforeAttributeName(e) {
    e === Kl.Gt
      ? (this.cbs.onopentagend(this.index),
        this.isSpecial
          ? ((this.state = jl.InSpecialTag), (this.sequenceIndex = 0))
          : (this.state = jl.Text),
        (this.baseState = this.state),
        (this.sectionStart = this.index + 1))
      : e === Kl.Slash
        ? (this.state = jl.InSelfClosingTag)
        : Ql(e) ||
  ...
  stateAfterAttributeName(e) {
    e === Kl.Eq
      ? (this.state = jl.BeforeAttributeValue)
      : e === Kl.Slash || e === Kl.Gt
  ...
  stateBeforeAttributeValue(e) {
    e === Kl.DoubleQuote
      ? ((this.state = jl.InAttributeValueDq),
        (this.sectionStart = this.index + 1))
      : e === Kl.SingleQuote
        ? ((this.state = jl.InAttributeValueSq),
          (this.sectionStart = this.index + 1))
        : Ql(e) ||
          ((this.sectionStart = this.index),
    ...
    e === t || (!this.decodeEntities && this.fastForwardTo(t))
      ? (this.cbs.onattribdata(this.sectionStart, this.index),
        ...
        this.cbs.onattribend(
          t === Kl.DoubleQuote ? Vl.Double : Vl.Single,
          this.index,
        ),
        (this.state = jl.BeforeAttributeName))
      : this.decodeEntities &&
        e === Kl.Amp &&
        ((this.baseState = this.state), (this.state = jl.BeforeEntity));
  }
  ...
  stateBeforeDeclaration(e) {
    e === Kl.OpeningSquareBracket
      ? ((this.state = jl.CDATASequence), (this.sequenceIndex = 0))
      : (this.state = e === Kl.Dash ? jl.BeforeComment : jl.InDeclaration);
  }
  ...
  stateBeforeSpecialS(e) {
    const t = 32 | e;
    t === zl.ScriptEnd[3]
      ? this.startSpecial(zl.ScriptEnd, 4)
      : t === zl.StyleEnd[3]
        ? this.startSpecial(zl.StyleEnd, 4)
        : ((this.state = jl.InTagName), this.stateInTagName(e));
  }
  stateBeforeEntity(e) {
    ((this.entityExcess = 1),
      (this.entityResult = 0),
      e === Kl.Num
        ? (this.state = jl.BeforeNumericEntity)
        : e === Kl.Amp ||
          ((this.trieIndex = 0),
  ...
  emitNamedEntity() {
    ...
    switch ((this.entityTrie[this.entityResult] & yo.VALUE_LENGTH) >> 14) {
      case 1:
        this.emitCodePoint(
          this.entityTrie[this.entityResult] & ~yo.VALUE_LENGTH,
        );
        break;
      case 2:
  ...
  stateBeforeNumericEntity(e) {
    (32 | e) === Kl.LowerX
      ? (this.entityExcess++, (this.state = jl.InHexEntity))
      : ((this.state = jl.InNumericEntity), this.stateInNumericEntity(e));
  }
  emitNumericEntity(e) {
    const t = this.index - this.entityExcess - 1;
    (t + 2 + Number(this.state === jl.InHexEntity) !== this.index &&
  ...
  stateInNumericEntity(e) {
    e === Kl.Semi
      ...
      : $l(e)
        ? ((this.entityResult = 10 * this.entityResult + (e - Kl.Zero)),
          this.entityExcess++)
  ...
  stateInHexEntity(e) {
    e === Kl.Semi
      ? this.emitNumericEntity(!0)
      : $l(e)
        ? ((this.entityResult = 16 * this.entityResult + (e - Kl.Zero)),
          this.entityExcess++)
        : !(function (e) {
              return (
                (e >= Kl.UpperA && e <= Kl.UpperF) ||
                (e >= Kl.LowerA && e <= Kl.LowerF)
              );
            })(e)
          ? (this.allowLegacyEntity()
              ? this.emitNumericEntity(!1)
            ...
            this.index--)
          : ((this.entityResult =
              16 * this.entityResult + ((32 | e) - Kl.LowerA + 10)),
            this.entityExcess++);
  }
  allowLegacyEntity() {
    return (
      !this.xmlMode &&
      (this.baseState === jl.Text || this.baseState === jl.InSpecialTag)
    );
  }
  cleanup() {
    this.running &&
      this.sectionStart !== this.index &&
      (this.state === jl.Text ||
      (this.state === jl.InSpecialTag && 0 === this.sequenceIndex)
        ? (this.cbs.ontext(this.sectionStart, this.index),
          (this.sectionStart = this.index))
        : (this.state !== jl.InAttributeValueDq &&
            this.state !== jl.InAttributeValueSq &&
    ...
    for (; this.shouldContinue(); ) {
      ...
      (this.state === jl.Text
        ...
        : this.state === jl.SpecialStartSequence
          ...
          : this.state === jl.InSpecialTag
            ? this.stateInSpecialTag(e)
            : this.state === jl.CDATASequence
              ...
              : this.state === jl.InAttributeValueDq
                ...
                : this.state === jl.InAttributeName
                  ...
                  : this.state === jl.InCommentLike
                    ...
                    : this.state === jl.InSpecialComment
                      ? this.stateInSpecialComment(e)
                      : this.state === jl.BeforeAttributeName
                        ? this.stateBeforeAttributeName(e)
                        : this.state === jl.InTagName
                          ? this.stateInTagName(e)
                          : this.state === jl.InClosingTagName
  ...
  handleTrailingData() {
    ...
    this.state === jl.InCommentLike
      ...
      : (this.state === jl.InNumericEntity && this.allowLegacyEntity()) ||
          (this.state === jl.InHexEntity && this.allowLegacyEntity())
        ? this.emitNumericEntity(!1)
        : this.state === jl.InTagName ||
          this.state === jl.BeforeAttributeName ||
          this.state === jl.BeforeAttributeValue ||
  ...
  constructor(e, t = {}) {
    ...
    ((this.options = t),
      ...
      (this.lowerCaseAttributeNames =
        null !== (r = t.lowerCaseAttributeNames) && void 0 !== r
          ? r
          : !t.xmlMode),
      (this.tokenizer = new (
        null !== (i = t.Tokenizer) && void 0 !== i ? i : Jl
      )(this.options, this)),
  ...
  emitOpenTag(e) {
    ...
    (this.isVoidElement(e) ||
      ...
      ah.has(e)
        ...
        : oh.has(e) && this.foreignContext.push(!1)),
  ...
  oncdata(e, t, n) {
    ...
    (this.options.xmlMode || this.options.recognizeCDATA
      ? (null === (i = (r = this.cbs).oncdatastart) ||
        ...
        null === (c = (o = this.cbs).oncdataend) || void 0 === c || c.call(o))
      : (null === (h = (l = this.cbs).oncomment) ||
          void 0 === h ||
          h.call(l, `[CDATA[${f}]]`),
        null === (p = (u = this.cbs).oncommentend) ||
          void 0 === p ||
          p.call(u)),
      (this.startIndex = t + 1));
  }
...
var hh = (function (e) {
    ...
    return t.xmlMode || t._useHtmlParser2
      ? (function (e, t) {
          ...
          return (new lh(n, t).end(e), n.root);
        })(e, t)
      : ql(e, t, n, r);
  }),
  uh = (function (e, t) {
    return function r(s, a, o) {
      ...
      function u(t, n, r, s) {
        if ((void 0 === r && (r = l), t && wi(t))) return t;
        var a = no(no({}, c), i(s)),
          o =
            "string" == typeof r
              ? [e(r, a, !1, null)]
        ...
        if (((u._root = u), !t)) return new h(void 0, u, a);
        var p,
          f =
            "string" == typeof t && Ui(t)
        ...
        var E = t,
          m = n
            ? "string" == typeof n
              ? Ui(n)
                ? new h([e(n, a, !1, null)], u, a)
                : ((E = "".concat(n, " ").concat(E)), u)
              : wi(n)
                ? n
                : new h(Array.isArray(n) ? n : [n], u, a)
            : u;
        return m ? m.find(E) : d;
      }
      return (
